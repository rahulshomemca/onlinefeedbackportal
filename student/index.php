...
{
	header('location:dash.php?q_no=1');
}
...
<div id="section2" class="container-fluid">
	<div class="container">
  <strong><p>Student Login</p></strong><br>
	...
	$pass = $_POST['pwd'];
		...
		else
        {
			...
			if(password_verify($pass, $row['password']))
			{
				...
				$_SESSION['order_id'] = 1;
				?>
				    <meta http-equiv="refresh" content="0; URL='dash.php?q_no=1'" />
				<?php
...
<div id="section3" class="container-fluid">
    ...
    <div class="col-sm-4">
      <p>Quick Links</p>
      <a href="index.php" style="text-decoration:none; color:white;">Student</a><br>
