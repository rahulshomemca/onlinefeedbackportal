...
<div class="container">
  <form action="update_f.php" method="post">
    ...
    <div class="form-group">
	      ...
	      <input type="number" class="form-control" id="mob" value="<?php echo $row['mobile']?>" name="mob">
	    </div>
			<div class="form-group">
	      <label for="desig">Designation:</label>
	      <input type="text" class="form-control" id="desig" value="<?php echo $row['desig']?>" name="desig">
	    </div>
			<div class="form-group">
